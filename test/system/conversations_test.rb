...
class ConversationsTest < ApplicationSystemTestCase
  ...
  test "creating a Conversation" do
    ...
    fill_in "Channel", with: @conversation.channel
    fill_in "Expire at", with: @conversation.expire_at
    fill_in "Mode", with: @conversation.mode
    fill_in "Status", with: @conversation.status
