...
class SourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create source" do
    assert_difference('Source.count') do
      post sources_url, params: { source: { display_name: @source.display_name, name: @source.name } }
    end
  ...
  test "should update source" do
    patch source_url(@source), params: { source: { display_name: @source.display_name, name: @source.name } }
